...
const CheckOut = () => {
    ...
    return (
        <div className='bg-base-300 min-h-screen'>
            <h1 className='text-primary-focus text-2xl md:text-3xl font-semibold py-4'>Congratulations!!</h1>
            <h3 className='text-primary text-lg md:text-xl font-semibold py-2'>You've got your premium access to the course,<br />{title}</h3>
